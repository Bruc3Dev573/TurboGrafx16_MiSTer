#!/bin/bash
# Full-core savestate determinism testbench (GHDL). Expect minutes of runtime.
# Usage: sim/run_tb_core.sh
set -e
...
$GHDL -e $FLAGS tb_core
exec $GHDL -r $FLAGS tb_core --max-stack-alloc=0 --ieee-asserts=disable
